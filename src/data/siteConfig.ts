...
export const siteConfig: SiteConfig = {
  ...
  about:
    "I am an AI-native engineer and a recent Computer Science graduate from Gettysburg College. Lately my favorite thing to build is a fleet of autonomous \"minions\": little agents that pick up a coding ticket, fix it, prove the fix with tests, and open a pull request, all while I am off doing something else. I care about software that genuinely helps people, and about building it with enough rigor to actually trust it. Outside of code, you will most likely find me lifting at the gym, experimenting with new baking recipes, or happily explaining to anyone who will listen why agents are the most exciting thing in tech right now.",
